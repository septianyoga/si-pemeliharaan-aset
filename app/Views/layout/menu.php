...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('admin/css/select2.css') ?>">
    <link rel="stylesheet" href="<?= base_url('admin/css/dropzone.css') ?>">
    <link rel="stylesheet" href="<?= base_url('admin/css/uppy.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('admin/css/jquery.steps.css') ?>">
    <link rel="stylesheet" href="<?= base_url('admin/css/jquery.timepicker.css') ?>">
    <link rel="stylesheet" href="<?= base_url('admin/css/quill.snow.css') ?>">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="auth">
                ...
                <a class="nav-link pl-3" href="<?= base_url('pages/login') ?>"><span class="ml-1">Login 2</span></a>
                    ...
                    <div class="card-body" data-simplebar style="height:355px; overflow-y: auto; overflow-x: hidden;">
                      ...
                      <div class="pb-3 timeline-item item-warning">
                        <div class="pl-5">
                          ...
                          <div class="row mb-3">
                            <div class="col"><img src="<?= base_url('admin//assets/products/p1.jpg') ?>" alt="..." class="img-fluid rounded"></div>
                            <div class="col"><img src="<?= base_url('admin//assets/products/p2.jpg') ?>" alt="..." class="img-fluid rounded"></div>
                            <div class="col"><img src="<?= base_url('admin//assets/products/p3.jpg') ?>" alt="..." class="img-fluid rounded"></div>
                            <div class="col"><img src="<?= base_url('admin//assets/products/p4.jpg') ?>" alt="..." class="img-fluid rounded"></div>
                          </div>
