...
<div class="d-flex justify-content-between">
    ...
    <div>
        <a href="<?= base_url('aset/add?pt=' . $_GET['pt']) ?>" class="btn btn-primary">Tambah</a>
    </div>
</div>
<div class="row my-4">
    <!-- Small table -->
                    ...
                    <tbody>
                        <?php foreach ($asets as $key => $aset) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-info" data-toggle="modal" data-target="#edit-<?= $aset['id_aset'] ?>"><i class="fe fe-edit fe-16"></i></button>
                                    <button onclick="handleDelete('/aset/<?= $aset['id_aset'] ?>')" class="btn btn-danger"><i class="fe fe-trash-2 fe-16"></i></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
